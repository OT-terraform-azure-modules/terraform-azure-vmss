...
variable "additional_unattend_content" {
  type        = list(any)
  description = "List of additional unwanted content "
}
...
variable "rolling_upgrade_policy" {
  type        = list(any)
  description = "Rolling upgrade policy for vmss"
}
...
variable "diff_disk_settings" {
  type        = list(any)
  description = "diff disk setting for vmss"
}
...
variable "os_disk" {
  type        = any
  description = "os flavor for vmss"
  default = {
...
variable "vmss_os_disk_diff_disk_settings_option" {
  description = "Setting to choose for os disk diff"
  type        = string
}
...
variable "vmss_network_interface_ip_configuration_application_gateway_backend_address_pool_ids" {
  description = "The ID of network interface ip configuration application gateway backend address pool"
  type        = set(string)
}
...
variable "vmss_network_interface_ip_configuration_load_balancer_backend_address_pool_ids" {
  description = "The ID of network interface ip configuration load balancer backend address pool"
  type        = set(string)
}
...
variable "vmss_network_interface_ip_configuration_public_ip_address_idle_timeout_in_minutes" {
  description = "Network interface ip configuration public ip address idle timeout in minutes value"
  type        = string
}
